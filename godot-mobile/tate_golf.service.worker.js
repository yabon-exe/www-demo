...
/** @type {string} */
const CACHE_VERSION = '1722329983|229846924417';
/** @type {string} */
const CACHE_PREFIX = 'tate_golf-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'tate_golf.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["tate_golf.html","tate_golf.js","tate_golf.offline.html","tate_golf.icon.png","tate_golf.apple-touch-icon.png","tate_golf.worker.js","tate_golf.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["tate_golf.wasm","tate_golf.pck"];
