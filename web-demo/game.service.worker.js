...
/** @type {string} */
const CACHE_VERSION = '1731204338|1848167669883';
/** @type {string} */
const CACHE_PREFIX = 'move_shooting-sw-cache-';
...
/** @type {string[]} */
const CACHED_FILES = ["game.html","game.js","game.offline.html","game.icon.png","game.apple-touch-icon.png","game.worker.js","game.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["game.wasm","game.pck"];
